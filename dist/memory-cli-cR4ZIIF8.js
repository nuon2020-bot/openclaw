...
import { Kt as splitShellArgs, j as loadConfig, rt as parseDurationMs } from "./auth-profiles-6WJHPoy1.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-CP14Ly4R.js";
import { t as formatDocsLink } from "./links-yQMT2QcX.js";
import { r as withManager } from "./cli-utils-CKDCmKAq.js";
import { t as formatHelpExamples } from "./help-format-Du-bXlH0.js";
import { n as withProgress, r as withProgressTotals } from "./progress-bvyZjsUc.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-DWltygwq.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-Z4x-EJPX.js").then((n) => n.t);
