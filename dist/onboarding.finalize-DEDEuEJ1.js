...
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-CUpt2978.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-qfrMQvIt.js";
...
import { t as runTui } from "./tui-5Pue4OSz.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DdRp6UXr.js").then((n) => n.r);
