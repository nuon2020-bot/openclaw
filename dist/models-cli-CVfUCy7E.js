...
import { St as resolveUsageProviderId, Xt as maskApiKey, Yt as describeFailoverError, a as DEFAULT_OAUTH_WARN_MS, d as runEmbeddedPiAgent, o as buildAuthHealthSummary, s as formatRemainingShort, xt as formatUsageWindowSummary, yt as loadProviderUsageSummary } from "./reply-Deht_wOB.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-CUpt2978.js";
import { f as defaultRuntime } from "./subsystem-DypCPrmP.js";
import "./openclaw-root-PhSD0wUu.js";
import "./exec-X_fw5eJV.js";
import { Dr as setAuthProfileOrder, Hr as resolveAuthProfileDisplayLabel, J as getCustomProviderApiKey, Lr as resolveAuthStorePathForDisplay, Or as upsertAuthProfile, Q as resolveEnvApiKey, Rr as resolveOpenClawAgentDir, Rt as loadConfig, Tr as listProfilesForProvider, X as resolveApiKeyForProvider, Z as resolveAwsSdkEnvVarName, _ as resolveModelRefFromString, _r as getShellEnvAppliedKeys, br as shouldEnableShellEnvFallback, c as modelKey, d as parseModelRef, ei as DEFAULT_MODEL, h as resolveDefaultModelForAgent, i as findNormalizedProviderValue, jr as ensureAuthProfileStore, lt as resolveAuthProfileOrder, m as resolveConfiguredModelRef, mt as resolveProfileUnusableUntilForDisplay, r as buildModelAliasIndex, ti as DEFAULT_PROVIDER, u as normalizeProviderId, un as parseDurationMs } from "./model-selection-J6oFwo9y.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-BimjyIkA.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DCK8tt6v.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CxPj6Z2y.js";
...
import { r as resolveForwardCompatModel } from "./model-BHwbm5WN.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-CzIyxbam.js";
import "./help-format-CWJQePOA.js";
import { r as withProgressTotals } from "./progress-OUlzaka3.js";
...
import { f as openUrl } from "./onboard-helpers-qfrMQvIt.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-Cu8yIjil.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-ND5_MsE_.js";
import { n as logConfigUpdated } from "./logging-DdGtENSb.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-C0DVH2g3.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./model-selection-J6oFwo9y.js").then((n) => n.Pt);
	const { ensureAuthProfileStore } = await import("./model-selection-J6oFwo9y.js").then((n) => n.ct);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-BHwbm5WN.js").then((n) => n.t);
