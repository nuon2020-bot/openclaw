...
import { H as resolveUserPath, Q as info, Z as danger, et as logVerboseConsole, i as defaultRuntime, it as warn, lt as getLogger, nt as shouldLogVerbose, t as createSubsystemLogger, z as pathExists$1 } from "./subsystem-Dov-90yx.js";
...
async function resolveBoundaryPathLexicalAsync(params) {
	...
	for (let idx = 0; idx < segments.length; idx += 1) {
		...
		let stat;
		try {
			stat = await fs$1.lstat(lexicalCursor);
		} catch (error) {
