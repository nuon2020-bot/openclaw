...
import { A as createConfigIO, An as isPidAlive, F as resolveConfigSnapshotHash, Fn as getModelRefStatus, Gn as resolveDefaultModelForAgent, Hn as resolveAllowedModelRef, Kn as resolveHooksGmailModel, L as writeConfigFile, Ln as isCliProvider, M as parseConfigJson5, N as readConfigFileSnapshot, O as migrateLegacyConfig, P as readConfigFileSnapshotForWrite, Qr as DEFAULT_PROVIDER, R as validateConfigObjectWithPlugins, Ur as normalizeSecretInput, Wn as resolveConfiguredModelRef, Xr as DEFAULT_CONTEXT_TOKENS, Xt as applyMergePatch, Yn as resolveSubagentConfiguredModelSelection, Zn as resolveThinkingDefault, Zr as DEFAULT_MODEL, Zt as applyLegacyMigrations, at as AVATAR_MAX_BYTES, cn as resolveAgentMaxConcurrent, ct as isAvatarImageDataUrl, ft as looksLikeAvatarPath, it as parseByteSize, j as loadConfig, jn as buildAllowedModelSet, ln as resolveSubagentMaxConcurrent, on as buildTalkConfigResponse, rt as parseDurationMs, st as isAvatarHttpUrl, z as OpenClawSchema } from "./auth-profiles-6WJHPoy1.js";
import { t as formatCliCommand } from "./command-format-CDHXQh1_.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-C2k6BQnt.js";
...
import { a as openBoundaryFileSync, d as isNotFoundPathError, i as openBoundaryFile, m as matchesSkillFilter, o as openVerifiedFileSync, s as sameFileIdentity, t as resolveOpenClawPackageRoot } from "./openclaw-root-C9tYgTzw.js";
...
import { i as resolveRuntimeServiceVersion, r as VERSION } from "./env-vars-DPtuUD7z.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-HLdbjiS7.js";
...
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-DOryi61N.js";
...
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CJUwnCYd.js";
import { $ as resolveAgentMainSessionKey, A as readSessionMessages, B as cleanStaleLockFiles, D as archiveSessionTranscripts, E as archiveFileOnDisk, F as stripEnvelopeFromMessages, G as resolveSessionResetPolicy, L as stripInlineDirectiveTagsForDisplay, N as resolveSessionTranscriptCandidates, O as capArrayByJsonBytes, P as stripEnvelopeFromMessage, Q as canonicalizeMainSessionAlias, R as stripInlineDirectiveTagsFromMessageForDisplay, S as mergeDeliveryContext, U as evaluateSessionFreshness, Y as mergeSessionEntry, Z as setSessionRuntimeModel, b as deliveryContextFromSession, c as loadSessionStore, et as resolveExplicitAgentSessionKey, h as updateSessionStore, it as snapshotSessionOrigin, j as readSessionPreviewItemsFromTranscript, k as cleanupArchivedSessionTranscripts, n as extractDeliveryInfo, nt as resolveMainSessionKeyFromConfig, r as parseSessionThreadInfo, tt as resolveMainSessionKey, w as normalizeSessionDeliveryFields } from "./sessions-CRMuaVTk.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BOmV0yTv.js";
import { i as resolveWhatsAppAccount } from "./accounts-jTTYYc3C.js";
import "./accounts-CnxuiQaw.js";
import "./accounts-DKgW2m_s.js";
import { t as buildChannelAccountBindings } from "./bindings-DcFNU_QL.js";
import "./logging-Cr3Gsq0-.js";
import "./send-Dwpn9TDt.js";
import "./send-CRKuzy2V.js";
import { $ as createReplyDispatcher, $n as isAbortRequestText, $t as resolveSessionAuthProfileOverride, A as createOutboundSendDeps, Ar as stripHeartbeatToken, B as buildHistoryContextFromEntries, Bn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Bt as normalizeRequiredName, C as computeBackoff, Cn as formatZonedTimestamp, Cr as setCommandLaneConcurrency, Ct as runWithModelFallback, Dt as formatRestartSentinelMessage, E as agentCommand, Er as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Et as formatDoctorNonInteractiveHint, Fr as registerAgentRunContext, Ft as inferLegacyName, Gn as extractImageContentFromSource, Hn as DEFAULT_INPUT_MAX_REDIRECTS, Ht as buildDeliveryFromLegacyPayload, It as normalizeOptionalAgentId, Jn as resolveAgentTimeoutMs, Jt as detectSuspiciousPatterns, Kn as normalizeMimeList, Ln as ACP_SESSION_IDENTITY_RENDERER_VERSION, Lt as normalizeOptionalSessionKey, M as createOutboundSendDeps$1, Mn as requestHeartbeatNow, Mr as emitAgentEvent, Mt as normalizeHttpWebhookUrl, N as resolveAgentAvatar, Nr as getAgentRunContext, Nt as normalizeCronJobCreate, O as resolveAgentDeliveryPlan, On as enqueueSystemEvent, Pr as onAgentEvent, Pt as normalizeCronJobPatch, Q as dispatchInboundMessage, Qt as persistBrowserProxyFiles, Rn as getAcpSessionManager, Rt as normalizeOptionalText, S as requestBodyErrorToText, Sr as resetAllLanes, Tr as CommandLane, Tt as consumeRestartSentinel, Un as DEFAULT_INPUT_TIMEOUT_MS, Ut as hasLegacyDeliveryHints, Vn as DEFAULT_INPUT_IMAGE_MIMES, Vt as migrateLegacyCronPayload, Wn as extractFileContentFromSource, Wt as stripLegacyDeliveryFields, Xn as resolveSendPolicy, Xt as isExternalHookSession, Yn as normalizeSendPolicy, Yt as getHookType, Zt as applyBrowserProxyPaths, _ as loadOpenClawPlugins, _r as OPENAI_TTS_VOICES, _t as resolveOutboundTarget, a as runSubagentAnnounceFlow, an as parseVerboseOverride, ar as getTtsProvider, at as resolveCronStyleNow, b as handleSlackHttpRequest, br as getTotalQueueSize, c as abortEmbeddedPiRun, cn as deferGatewayRestartUntilIdle, cr as resolveTtsApiKey, ct as runCliAgent, d as applyToolPolicyPipeline, dn as markGatewaySigusr1RestartHandled, dr as resolveTtsPrefsPath, dt as resolveAnnounceTargetFromKey, er as stopSubagentsForRequester, et as getTotalPendingReplies, f as buildDefaultToolPolicyPipelineSteps, fn as scheduleGatewaySigusr1Restart, fr as resolveTtsProviderOrder, gn as normalizeGroupActivation, gr as OPENAI_TTS_MODELS, h as resolvePluginTools, hn as unbindThreadBindingsBySessionKey, hr as textToSpeech, in as applyVerboseOverride, ir as clearBootstrapSnapshot, j as createDefaultDeps, jr as clearAgentRunContext, jt as writeRestartSentinel, k as resolveAgentOutboundTarget, kn as isSystemEventContextChanged, kt as summarizeRestartSentinel, l as getActiveEmbeddedRunCount, ln as emitGatewayRestart, lr as resolveTtsAutoMode, lt as createOpenClawTools, m as getPluginToolMeta, mn as setPreRestartDeferralCheck, mr as setTtsProvider, mt as resolveOutboundSessionRoute, n as initSubagentRegistry, o as clearSessionQueues, on as buildOutboundSessionContext, or as isTtsEnabled, ot as getCliSessionId, pn as setGatewaySigusr1RestartPolicy, pr as setTtsEnabled, pt as ensureOutboundSessionEntry, qn as resolveInputFileLimits, qt as buildSafeExternalPrompt, r as listDescendantRunsForRequester, rn as applyModelOverrideToSessionEntry, rr as resolveUserTimezone, rt as BARE_SESSION_RESET_PROMPT, s as runEmbeddedPiAgent, sn as consumeGatewaySigusr1RestartAuthorization, sr as isTtsProviderConfigured, st as setCliSessionId, t as countActiveDescendantRuns, u as waitForEmbeddedPiRunEnd, un as isGatewaySigusr1RestartExternallyAllowed, ur as resolveTtsConfig, ut as readLatestAssistantReply, vn as loadProviderUsageSummary, vr as getActiveTaskCount, vt as resolveSessionDeliveryTarget, w as sleepWithAbort, wr as waitForActiveTasks, x as readJsonBodyWithLimit, xr as markGatewayDraining, xt as resetDirectoryCache, yt as resolveOutboundChannelPlugin, zn as resolveAgentSessionDirs, zt as normalizePayloadToSystemText } from "./subagent-registry-CVXe4Cfs.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-ANQqR741.js";
import { i as normalizeInputProvenance } from "./input-provenance-BDYpbBeC.js";
import "./chat-envelope-CrHAOMhr.js";
import { $ as validateNodePairRejectParams, A as validateCronStatusParams, At as PROTOCOL_VERSION, B as validateExecApprovalsGetParams, Bt as getPairedDevice, C as validateConfigSetParams, Ct as validateWakeParams, D as validateCronRemoveParams, Dt as validateWizardNextParams, E as validateCronListParams, Et as validateWizardCancelParams, F as validateDevicePairRemoveParams, Ft as buildDeviceAuthPayload, G as validateModelsListParams, Gt as revokeDeviceToken, H as validateExecApprovalsNodeSetParams, Ht as rejectDevicePairing, I as validateDeviceTokenRevokeParams, It as buildDeviceAuthPayloadV3, J as validateNodeInvokeParams, Jt as updatePairedDeviceMetadata, K as validateNodeDescribeParams, Kt as rotateDeviceToken, L as validateDeviceTokenRotateParams, Lt as normalizeDeviceMetadataForAuth, M as validateDevicePairApproveParams, Mt as errorShape, N as validateDevicePairListParams, O as validateCronRunParams, Ot as validateWizardStartParams, P as validateDevicePairRejectParams, Pt as parseSessionLabel, Q as validateNodePairListParams, Qt as deriveDeviceIdFromPublicKey, R as validateExecApprovalRequestParams, Rt as approveDevicePairing, S as validateConfigSchemaParams, St as validateUpdateRunParams, T as validateCronAddParams, Tt as validateWebLoginWaitParams, U as validateExecApprovalsSetParams, Ut as removePairedDevice, V as validateExecApprovalsNodeGetParams, Vt as listDevicePairing, W as validateLogsTailParams, Wt as requestDevicePairing, X as validateNodeListParams, Xt as roleScopesAllow, Y as validateNodeInvokeResultParams, Yt as verifyDeviceToken, Z as validateNodePairApproveParams, _ as validateChatInjectParams, _t as validateSkillsStatusParams, a as validateAgentWaitParams, at as validateRequestFrame, b as validateConfigGetParams, bt as validateTalkModeParams, c as validateAgentsFilesGetParams, ct as validateSessionsDeleteParams, d as validateAgentsListParams, dt as validateSessionsPreviewParams, en as normalizeDevicePublicKeyBase64Url, et as validateNodePairRequestParams, f as validateAgentsUpdateParams, ft as validateSessionsResetParams, g as validateChatHistoryParams, gt as validateSkillsInstallParams, h as validateChatAbortParams, ht as validateSkillsBinsParams, i as validateAgentParams, it as validatePushTestParams, j as validateCronUpdateParams, jt as ErrorCodes, k as validateCronRunsParams, kt as validateWizardStatusParams, l as validateAgentsFilesListParams, lt as validateSessionsListParams, m as validateChannelsStatusParams, mt as validateSessionsUsageParams, n as formatValidationErrors, nt as validateNodeRenameParams, o as validateAgentsCreateParams, ot as validateSendParams, p as validateChannelsLogoutParams, pt as validateSessionsResolveParams, q as validateNodeEventParams, qt as summarizeDeviceTokens, r as validateAgentIdentityParams, rt as validatePollParams, s as validateAgentsDeleteParams, st as validateSessionsCompactParams, tn as verifyDeviceSignature, tt as validateNodePairVerifyParams, u as validateAgentsFilesSetParams, ut as validateSessionsPatchParams, v as validateChatSendParams, vt as validateSkillsUpdateParams, w as validateConnectParams, wt as validateWebLoginStartParams, x as validateConfigPatchParams, xt as validateToolsCatalogParams, y as validateConfigApplyParams, yt as validateTalkConfigParams, z as validateExecApprovalResolveParams, zt as ensureDeviceToken } from "./client-C2kv9X_7.js";
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-D_7wmgxh.js";
...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-DBSF8WcF.js";
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-DIzJJMMZ.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-ilkPeYFb.js";
import "./diagnostic-session-state-Cw3EMvZy.js";
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-DslMV0Oj.js";
import { c as detectMime } from "./image-ops-WZr1HLCX.js";
import "./pi-embedded-helpers-CpQ-YZT5.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-DY8nmmZL.js";
...
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-ML-4Xoce.js";
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-cmI3JR7x.js";
...
import { i as writeFileWithinRoot, n as openFileWithinRoot, r as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-BhLTWc_h.js";
import { t as SsrFBlockedError } from "./ssrf-Bte-xH9B.js";
import "./store-BXu3Rh07.js";
import { n as inspectPortUsage, o as formatPortDiagnostics, t as ensurePortAvailable } from "./ports-B9YOEPbT.js";
...
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-CJW3v-NP.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-cR4ZIIF8.js";
import { n as resolveMemorySearchConfig } from "./manager-Z4x-EJPX.js";
...
import { a as ToolInputError } from "./target-errors-DxuxEzkD.js";
...
import { r as isRestartEnabled } from "./commands-CQRE0cc7.js";
import "./commands-registry-B0c36EOd.js";
import { S as extractTextFromChatContent } from "./image-n4jQhuqR.js";
import "./tool-display-FacPPVzc.js";
import { d as registerUnhandledRejectionHandler } from "./runner-BILcju_L.js";
import { n as loadModelCatalog } from "./model-catalog-BiejcmsY.js";
import "./fetch-CgA7FwwB.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-CP4oUWWz.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-UjbIDJw1.js";
...
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-BE71Amqa.js";
...
import { n as resolveSystemRunCommand } from "./system-run-command-D0tcgV6x.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-DqbBHZcv.js";
...
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-CUuJedqj.js";
...
import { t as resolveChannelDefaultAccountId } from "./helpers-DARwxcOD.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DroAPfoV.js";
import { t as isWithinDir } from "./path-safety-CO2CG0EJ.js";
...
import "./channels-status-issues-Glnt1vMs.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-Bxwpmu0s.js";
...
import "./lifecycle-core-DLzNOqjt.js";
import "./systemd-hints-CN7HXgoe.js";
import { t as parsePort$1 } from "./parse-port-e2GZqX81.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-CC_pWPtZ.js";
import "./diagnostics-DEbvpGB5.js";
import "./table-Bh_v2d9K.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-TFrKNSIy.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BbXAvc8g.js";
import { a as isNodeCommandAllowed, n as collectEnabledInsecureOrDangerousFlags, o as resolveNodeCommandAllowlist, s as probeGateway } from "./audit-CKXndX7m.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-Dt9GfPAK.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-CNaXnDB-.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-96TiBcbt.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-1IbZOG4l.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-D1iDSwwc.js";
import { i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-rZwnImkz.js";
import { t as runOnboardingWizard } from "./onboarding-CYbFv7Ct.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BEo1cMhc.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-BWM7dDzB.js";
import "./node-service-Dib0ppGJ.js";
import "./status.update-DYxvWg39.js";
import { a as matchSystemRunApprovalBindingV1, i as buildSystemRunApprovalBindingV1, n as resolveSystemRunApprovalRequestContext, o as missingSystemRunApprovalBindingV1, r as resolveSystemRunApprovalRuntimeContext, s as toSystemRunApprovalMismatchError } from "./system-run-approval-context-BIdApgPP.js";
import { t as installSkill } from "./skills-install-B_-q8vKL.js";
import { t as runGatewayUpdate } from "./update-runner-BXxMBAQK.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-D-Kx50oI.js";
import { n as forceFreePortAndWait } from "./ports-Dv-7eOvd.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-B8LasKj2.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-B1Kk2v41.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-JM7ORnZ3.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-C7pBPro_.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-DIzJJMMZ.js").then((n) => n.n);
