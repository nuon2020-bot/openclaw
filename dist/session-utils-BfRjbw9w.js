...
import { Dn as resolveOpenClawAgentDir, Gn as resolveDefaultModelForAgent, In as inferUniqueProviderFromConfiguredModels, Qr as DEFAULT_PROVIDER, Vn as parseModelRef, Wn as resolveConfiguredModelRef, Xr as DEFAULT_CONTEXT_TOKENS, Zr as DEFAULT_MODEL, at as AVATAR_MAX_BYTES, dt as isWorkspaceRelativeAvatarPath, j as loadConfig, lt as isPathWithinRoot, ot as isAvatarDataUrl, pt as resolveAvatarMime, st as isAvatarHttpUrl } from "./auth-profiles-6WJHPoy1.js";
...
import { $ as resolveAgentMainSessionKey, M as readSessionTitleFieldsFromTranscript, Q as canonicalizeMainSessionAlias, X as resolveFreshSessionTotalTokens, c as loadSessionStore, st as buildGroupDisplayName, tt as resolveMainSessionKey, w as normalizeSessionDeliveryFields } from "./sessions-CRMuaVTk.js";
...
(async () => {
	...
	try {
		const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-BCUHcNVb.js").then((n) => n.r);
