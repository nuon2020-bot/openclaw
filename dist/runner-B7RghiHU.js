import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-CiUx4u3k.js";
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir } from "./subsystem-CGE2Gr4r.js";
import { _ as runExec } from "./workspace-Coo0-24P.js";
import { E as resolveApiKeyForProvider, J as isInboundPathAllowed, R as loadConfig, T as requireApiKey, X as resolveIMessageAttachmentRoots, Y as mergeInboundPathRoots, c as normalizeProviderId, dn as resolveOpenClawAgentDir, g as normalizeGoogleModelId, q as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./model-selection-BNuytbkf.js";
import { t as normalizeChatType } from "./chat-type-C1pJ3wmC.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-ytIXc4y7.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-BaNRoyvf.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-DK0J4Ghx.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DwuL9y6C.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-ClDBVUl3.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-BHi_eOQs.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-YehKBAM7.js").then((n) => n.r);
