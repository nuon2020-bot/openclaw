...
import { $r as resolveAuthProfileDisplayLabel, Ar as getShellEnvAppliedKeys, Bn as normalizeProviderId, Dn as resolveOpenClawAgentDir, Dr as resolveAwsSdkEnvVarName, En as resolveAuthStorePathForDisplay, Er as resolveApiKeyForProvider, Gn as resolveDefaultModelForAgent, Nn as buildModelAliasIndex, Nr as shouldEnableShellEnvFallback, Or as resolveEnvApiKey, Pn as findNormalizedProviderValue, Qr as DEFAULT_PROVIDER, Rn as modelKey, Vn as parseModelRef, Wn as resolveConfiguredModelRef, Zr as DEFAULT_MODEL, _n as upsertAuthProfile, bn as ensureAuthProfileStore, gn as setAuthProfileOrder, j as loadConfig, mn as listProfilesForProvider, n as resolveAuthProfileOrder, qn as resolveModelRefFromString, rt as parseDurationMs, s as resolveProfileUnusableUntilForDisplay, wr as getCustomProviderApiKey } from "./auth-profiles-6WJHPoy1.js";
import { t as formatCliCommand } from "./command-format-CDHXQh1_.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-C2k6BQnt.js";
import { r as resolveForwardCompatModel } from "./model-CCg-E8K2.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-BCUHcNVb.js";
import { Sn as maskApiKey, bn as formatUsageWindowSummary, en as DEFAULT_OAUTH_WARN_MS, nn as formatRemainingShort, s as runEmbeddedPiAgent, tn as buildAuthHealthSummary, vn as loadProviderUsageSummary, wt as describeFailoverError, xn as resolveUsageProviderId } from "./subagent-registry-CVXe4Cfs.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-ANQqR741.js";
import { t as ensureOpenClawModelsJson } from "./models-config-Bx4oz_93.js";
import { n as loadModelCatalog } from "./model-catalog-BiejcmsY.js";
import { r as withProgressTotals } from "./progress-bvyZjsUc.js";
import { f as openUrl } from "./onboard-helpers-CUuJedqj.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-wsroINzm.js";
import { t as createClackPrompter } from "./clack-prompter-BpQAJLh9.js";
import { t as renderTable } from "./table-Bh_v2d9K.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-DfK9g6fg.js";
import { n as redactSecrets } from "./format-gUk9rXI2.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-czkqvFkr.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CBlm7E9U.js";
import { n as logConfigUpdated } from "./logging-DY1J23zp.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-UdUnoqgl.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./auth-profiles-6WJHPoy1.js").then((n) => n.D);
	const { ensureAuthProfileStore } = await import("./auth-profiles-6WJHPoy1.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CCg-E8K2.js").then((n) => n.t);
